...
public:
    ...
    void setupUi(QDialog *Note_Abs)
    {
        ...
        tabWidget->setGeometry(QRect(10, 20, 501, 321));
        QFont font;
        ...
        horizontalLayoutWidget_3->setGeometry(QRect(10, 200, 468, 71));
        ...
        horizontalLayoutWidget_4->setGeometry(QRect(10, 200, 468, 71));
